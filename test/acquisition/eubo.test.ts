...
import { createPairwiseGP } from "../../src/models/pairwise_gp.js";
...
function makePairwiseGP(): PairwiseGP {
  ...
  const utility = [0, 0.5, 0.3, 1]; // (1,1) is best
  ...
  const state: PairwiseGPModelState = {
    ...
    kernel: {
      type: "Scale",
      outputscale: 1,
      base_kernel: { type: "RBF", lengthscale: [0.5, 0.5] },
    },
    mean_constant: 0,
  };
